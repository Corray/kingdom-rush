...
**skill 实现位置：** `skills/extension/tapd-worktime/SKILL.md` Step 1（详见该 SKILL 文档）。
...
**skill 防御：** skill Step 4 写回前必须做 Issue↔TAPD 一致性校验（详见 `skills/extension/tapd-worktime/SKILL.md` Step 4），三态对比：
...
- `skills/extension/tapd-worktime/`（本协议的执行 skill — 5-09 同期落地）
