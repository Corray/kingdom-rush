...
| 编号 | 首次发现 | 当前状态 | 说明 | 关联 |
|------|---------|---------|------|------|
| IPR-001 | 2026-05-15 | **confirmed** (2026-05-18) | closed 事件早于 be-confirmed,违反 protocol 维度 1 #4（HIGH）；review 认可,进 fixing；衍生动作:KR-FB-005 occurrences +1 | audit/2026-05-15-issue-process.md / KR-FB-005 / P-001 / handoff/completed/2026-05/2026-05-18-adjudication-* |
...
| IPR-003 | 2026-05-15 | **deferred** (2026-05-18) | bootstrap 阶段 main.go 仅含字面量,无业务逻辑可测；触发条件:active phase 引入第一个有逻辑分支的函数时改 confirmed → fixing | audit/2026-05-15-issue-process.md / P-003 |
